...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.showSplashImage
          ? Builder(
              builder: (context) => Container(
                ...
                child: Image.asset(
                  'assets/images/VsoNoXzVf8Oa_1242_2688.png',
                  fit: BoxFit.cover,
                ),
              ),
            )
      ...
      routes: [
        ...
        FFRoute(
          name: DocumentListWidget.routeName,
          path: DocumentListWidget.routePath,
        ...
        FFRoute(
          ...
          path: EventsupdatesPageCopyWidget.routePath,
          builder: (context, params) => EventsupdatesPageCopyWidget(),
        ),
        FFRoute(
          name: MeetingUpdatesCopyWidget.routeName,
          path: MeetingUpdatesCopyWidget.routePath,
          builder: (context, params) => MeetingUpdatesCopyWidget(),
        ),
        FFRoute(
          name: FolderDetailsPreviewWidget.routeName,
          path: FolderDetailsPreviewWidget.routePath,
          builder: (context, params) => FolderDetailsPreviewWidget(),
        ),
        FFRoute(
          name: DocumentPreviewWidget.routeName,
          path: DocumentPreviewWidget.routePath,
          builder: (context, params) => DocumentPreviewWidget(
            pdf: params.getParam(
              'pdf',
              ParamType.String,
            ),
