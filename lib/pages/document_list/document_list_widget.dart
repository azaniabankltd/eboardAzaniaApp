...
import 'document_list_model.dart';
export 'document_list_model.dart';

class DocumentListWidget extends StatefulWidget {
  const DocumentListWidget({super.key});

  static String routeName = 'DocumentList';
  static String routePath = '/documentList';
...
class _DocumentListWidgetState extends State<DocumentListWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DocumentListModel());
  }
